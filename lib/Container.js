												...
												for (var i = 0; i < this.props.photos.length; i += rowLimit) {
																...
																for (var k = i; k < i + rowLimit; k++) {
																				...
																				if (this.props.handlePhotoClick) {
																								...
																								// Use explicit width and height as specified for each photo
																								var imageHeight = this.props.photos[k].height;
																								var imageWidth = this.props.photos[k].width;
																								photoPreviewNodes.push(_react2['default'].createElement(
																												'div',
																												{ key: k, style: style },
																												_react2['default'].createElement(
																																...
																																_react2['default'].createElement('img', { src: src, style: { display: 'block', border: 0 }, height: imageHeight, width: imageWidth, alt: '' })
																												)
																								));
																				}
																}
