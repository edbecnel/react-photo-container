...
var _reactPhotoContainer = require('react-photo-container');

var _reactPhotoContainer2 = _interopRequireDefault(_reactPhotoContainer);
...
var App = (function (_React$Component) {
    ...
    function App() {
        ...
        this.state = { photos: null, pageNum: 1, totalPages: 1, loadedAll: false, custom: { mobile: 4, desktop: 2 } };
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            this.loadMorePhotos();
            this.loadMorePhotos = _lodash2['default'].debounce(this.loadMorePhotos, 200);
        ...
        value: function loadMorePhotos(e) {
            ...
            _jquery2['default'].ajax({
                ...
                success: (function (data) {
                    var photos = data.photoset.photo.map(function (obj, i) {
                        var aspectRatio = parseFloat(obj.width_o / obj.height_o);
                        return {
...
},{"jquery":2,"lodash":3,"react":undefined,"react-dom":undefined,"react-images":undefined,"react-photo-container":undefined}],2:[function(require,module,exports){
/*!
